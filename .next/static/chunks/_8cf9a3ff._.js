...
function PetProfilePage() {
    ...
    const publicUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PetProfilePage.useMemo[publicUrl]": ()=>decodeURIComponent(params.id || "")
    }["PetProfilePage.useMemo[publicUrl]"], [
        params.id
    ]);
        ...
        "PetProfilePage.useEffect": ()=>{
            async function loadPet() {
                try {
                    setLoading(true);
                    setError("");
                    const details = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchPetByPublicUrl"])(publicUrl);
                    setPet(details);
                } catch (e) {
...
_s(PetProfilePage, "MqePPWT7szTG2m8dT0IKUz9904U=", false, function() {
    return [
...
//# sourceMappingURL=_8cf9a3ff._.js.map