...
const API_BASE = process.env.NEXT_PUBLIC_API_BASE_URL || "http://192.168.1.23:8080";
...
async function fetchPetsByOwner(userName, token) {
    const res = await fetch(`${API_BASE}/info/get/${encodeURIComponent(userName)}`, {
        method: "GET",
        headers: authHeaders(token),
        cache: "no-store"
    });
...
async function deletePetByName(petName, token) {
    const res = await fetch(`${API_BASE}/info/delete/${encodeURIComponent(petName)}`, {
        method: "DELETE",
        headers: authHeaders(token)
    });
...
function PetProfilePage() {
    ...
    const petNameFromUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>decodeURIComponent(params.id || ""), [
        params.id
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadPet() {
            try {
                setLoading(true);
                setError("");
                const session = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$session$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSession"])();
                const token = session?.token || "";
                let list = [];
                if (ownerUserName) {
                    list = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchPetsByOwner"])(ownerUserName, token);
                } else {
                    list = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchAllPets"])(token);
                }
                const found = list.find((item)=>item.petName.toLowerCase() === petNameFromUrl.toLowerCase());
                if (!found) {
...
//# sourceMappingURL=_f4e9bbcf._.js.map